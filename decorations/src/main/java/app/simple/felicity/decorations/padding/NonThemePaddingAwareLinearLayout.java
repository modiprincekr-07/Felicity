...
public class NonThemePaddingAwareLinearLayout extends LinearLayout implements SharedPreferences.OnSharedPreferenceChangeListener {
    
    private boolean statusPaddingRequired = true;
    private boolean navigationPaddingRequired = true;
    
    public NonThemePaddingAwareLinearLayout(Context context) {
        super(context);
        init(null);
    }
    
    public NonThemePaddingAwareLinearLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    
    public NonThemePaddingAwareLinearLayout(@NotNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
